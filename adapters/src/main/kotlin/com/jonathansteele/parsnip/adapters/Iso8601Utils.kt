...
internal object Iso8601Utils {
    ...
    fun format(date: Date?): String {
        ...
        // estimate capacity of buffer than close as we can (yeah, that's pedantic ;)
     ...
     *
     * @param date ISO strings to parse in the appropriate format.
    ...
    fun parse(date: String): Date {
        try {
                ...
                if (date.length > offset) {
                    ...
                    if (c != 'Z' && c != '+' && c != '-') {
                        ...
                        if (checkOffset(date, offset, '.')) {
                            ...
                            val parseEndOffset = endOffset.coerceAtMost(offset + 3) // parse up to 3 digits
            ...
            throw IOException("Not an RFC 3339 date: $date")
