    ...
    internal companion object {
        ...
        fun <T> newAdapterFactory(
            ...
            return XmlAdapter.Factory { targetType, annotations, _ ->
                if (annotations?.isEmpty() == true && typesMatch(type, targetType!!)) xmlAdapter else null
            }
        }
        ...
        fun <T> newConverterFactory(
            ...
            return TypeConverter.Factory { targetType, annotations ->
                if (annotations?.isEmpty() == true && typesMatch(type, targetType!!)) typeConverter else null
            }
        }
