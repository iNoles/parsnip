...
import com.jonathansteele.parsnip.jackson.medium.JacksonMediumXmlBenchmark;
import com.jonathansteele.parsnip.jackson.small.JacksonSmallXmlBenchmark;
import com.jonathansteele.parsnip.parnsip.small.ParsnipSmallXmlBenchmark;
import com.jonathansteele.parsnip.simple.medium.SimpleFrameworkMediumXmlBenchmark;
import com.jonathansteele.parsnip.simple.small.SimpleFrameworkSmallXmlBenchmark;
import com.jonathansteele.parsnip.tikxml.medium.TikXmlMediumXmlBenchmark;
import com.jonathansteele.parsnip.tikxml.small.TikXmlSmallXmlBenchmark;
...
public class XmlParsingBenchmark {
    ...
    public static class XmlBenchmark {
        ...
        @Benchmark
        public void parnsip_InputSmall() throws Exception {
            new ParsnipSmallXmlBenchmark().parse(xmlSmall);
        }
